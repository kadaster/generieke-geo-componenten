...
(async () => {
  ...
  const GgcSearchLocationElement = createCustomElement(
  ...
  const GgcLayerBrtAchtergrondkaart = createCustomElement(
    GgcLayerBrtAchtergrondkaartComponent,
    {
      injector: app.injector
    }
  ...
  customElements.define(
    "ggc-layer-brt-achtergrondkaart",
    GgcLayerBrtAchtergrondkaart
  );
})();
